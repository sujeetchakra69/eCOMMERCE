...
class TtextTheme{
  ...
  static TextTheme lighttextTheme= TextTheme(
    ...
    headlineMedium: const TextStyle().copyWith(fontSize: 25, fontWeight: FontWeight.w600,color: Colors.black),
    headlineSmall: const TextStyle().copyWith(fontSize: 20, fontWeight: FontWeight.w300,color: Colors.black),
  ...
  headlineLarge: const TextStyle().copyWith(fontSize: 32, fontWeight: FontWeight.bold,color: Colors.white),
    headlineMedium: const TextStyle().copyWith(fontSize: 25, fontWeight: FontWeight.w600,color: Colors.white),
    headlineSmall: const TextStyle().copyWith(fontSize: 20, fontWeight: FontWeight.w300,color: Colors.white),
